                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="card shadow mb-4">
                            ...
                            <div
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Przegląd Zysków</h6>
                                <div class="dropdown no-arrow">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                        ...
                                        <div class="dropdown-header">Możliwe akcje:</div>
                                        <a class="dropdown-item" href="#">Akcja</a>
                                        <a class="dropdown-item" href="#">Inna akcja</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="#">Coś jeszcze innego</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Card Body -->
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="card shadow mb-4">
                            ...
                            <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Źródła Przychodów</h6>
                                <div class="dropdown no-arrow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Bezpośrednie
                                        </span>
                                    <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Socjalne
                                        </span>
                                    <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Z Poleceń
                                        </span>
                                </div>
                            </div>
                        </div>
